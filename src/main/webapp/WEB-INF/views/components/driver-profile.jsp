		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form:form method="POST" modelAttribute="profile"
					action="${contextPath}/my-profile/edit-driver-${user.id}"
					class="form-driver-edit">
...
<div class="row">
	<div class="container-fluid">
		...
		<div class="col-md-5">
					...
					<div class="media-body">
						...
						<div class="table-responsive">
							<table class="table table-responsive table-striped">
								...
								<tr>
									<td>Rating</td>
									<td><c:set var="rating" value="${driver.rating}" /> <fmt:parseNumber
			...
			<br> <a href="new-trip.jsp"
				class="btn btn-lg btn-block btn-success">New Trip</a><br> <a
				href="search.jsp" class="btn btn-lg btn-block btn-info">Search
				for Companions</a><br>
		</div>
	</div>
</div>
